...
np.save("average_diff_network_as_a_meM1.npy", average_diff_network_as_a_mem1)
np.save("average_success_rates_network_as_a_meM1.npy", average_success_rates)
np.save("average_success_diff_network_as_a_meM1.npy", average_diff_success)
...
plt.xlabel("Number of Requests", fontsize=12)
plt.ylabel("Average Time Difference for successful requests(seconds)", fontsize=12)
plt.title("Mean Time Deviation vs Number of Requests", fontsize=14)
plt.legend(fontsize=11)
plt.grid(True)
plt.tight_layout()
...
plt.figure(figsize=(10, 6))
plt.plot(num_requests_list, average_success_rates, label="Average Success Rate", marker='o', linewidth=2)
plt.xlabel("Number of Requests", fontsize=12)
...
plt.plot(num_requests_list, average_diff, label="All Requests")
...
plt.plot(num_requests_list, average_diff_success, label="Successful Only", color='orange')
plt.xlabel("Number of Requests")
plt.ylabel("Avg. Time Difference (s)")
