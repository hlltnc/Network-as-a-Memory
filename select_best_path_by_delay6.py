...
def select_best_path_by_delay(G, src, dst, path_delay, fidelities, kappa, DDC=0.0000001, c_fiber=2e8, max_paths=10):
    def get_fidelity(u, v):
        return fidelities.get((u, v)) or fidelities.get((v, u))

    delay_tolerance = DDC * path_delay  # delay toleransı DDC ile belirleniyor
