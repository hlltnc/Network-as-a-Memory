...
np.save("SIMTIMEaverage_diff_memory_assisted_tau_meM_0.npy", average_diff)
np.save("SIMTIMEaverage_success_rates_memory_assisted_tau_meM_0.npy", average_success_rates)
np.save("SIMTIMEaverage_diff_memory_assisted_tau_meM_0_succ.npy", average_diff_success)


# Grafik çizimi
plt.figure(figsize=(10, 6))
plt.plot(simulation_time_list , average_diff_success, label="Mean Time Deviation", marker='o', linewidth=2)
...
plt.figure(figsize=(10, 6))
plt.plot( simulation_time_list , average_diff, label="Mean Time Deviation", marker='o', linewidth=2)
plt.xlabel("Number of Requests", fontsize=12)
...
# Grafik çizimi
plt.figure(figsize=(10, 6))
plt.plot( simulation_time_list , average_success_rates, label="success rate", marker='o', linewidth=2)
plt.xlabel("Number of Requests", fontsize=12)
...
plt.figure(figsize=(12, 5))  # Geniş bir figür tanımla

# 1. subplot (sol)
plt.subplot(1, 2, 1)  # 1 satır, 2 sütun, 1. grafik
plt.plot(simulation_time_list, average_diff, label="All Requests")
plt.xlabel("Number of Requests")
plt.ylabel("Avg. Time Difference (s)")
...
plt.plot(simulation_time_list, average_diff_success, label="Successful Only", color='orange')
plt.xlabel("Number of Requests")
plt.ylabel("Avg. Time Difference (s)")
