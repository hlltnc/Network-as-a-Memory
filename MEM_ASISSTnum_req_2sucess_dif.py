...
np.save("average_diff_memory_assisted_tau_meM_0.npy", average_diff)
np.save("average_success_rates_memory_assisted_tau_meM_0.npy", average_success_rates)
np.save("average_diff_memory_assisted_tau_meM_0_succ.npy", average_diff_success)
