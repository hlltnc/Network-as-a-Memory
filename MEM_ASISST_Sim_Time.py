...
np.save("average_diff_memory_assisted_tau_mem_0_sim_time.npy", average_diff)
np.save("average_success_rates_memory_assisted_tau_mem_0_sim_time.npy", average_success_rates)
